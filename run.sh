#!/bin/bash
#######################################################
# Run using `curl -s bench.devbeo.com/run.sh | bash`
# or `wget -qO- bench.devbeo.com/run.sh | bash`
#######################################################
...
echo "Benchmark is now complete! Bench data is saved to /root/bench.log"
